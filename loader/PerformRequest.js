...
var performRequest = /** @class */ (function () {
    function performRequest() {
        this.data = ''; //run the express instance and store in app
        this.endpoint = 'http://api.openweathermap.org/data/2.5/weather?q=London,uk&appid=44db6a862fba0b067b1930da0d769e98';
    }
    performRequest.prototype.getWeather = function (url) {
        $.getJSON(url, function (indata) { this.data = indata; });
        return this.data;
    };
...
;
/*
exports.performRequest = functiton() {
  constructor{
     public host: string; = 'https://api.darksky.net/forecast/',
     public apiKey: string = '88320e4d95c5cc9081084e3ae49dfecd',
     public latitude: = '37.8267',
     public longitude: = '-122.4233',
     public time: = '',
     public buildRequest: string = host + key + '/' + latitude + ',' + longitude + ',' + time;
  }
